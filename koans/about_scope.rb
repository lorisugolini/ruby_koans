...
class AboutScope < Neo::Koan
  ...
  # UGL aggiunto io
  ThisIsAnotherConstant = 1

  def test_constants_are_defined_with_an_initial_uppercase_letter
    assert_equal 3.1416, PI

    # UGL aggiunto io
    assert_equal 1, ThisIsAnotherConstant

    begin
      eval "ThisIsAnotherConstant = 2"
      # UGL: Using eval because the above line is a syntax error, ma 
      #      in realtà con l'eval non lancia eccezione... boho
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    assert_equal [:Dog], Jims.constants # UGL come mai con i ":" davanti???
