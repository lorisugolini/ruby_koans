...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional
    ...
    # UGL aggiunte io
    assert_equal "", "abbcccddddeeeee"[/z?/] # UGL occhio, non nil
    assert_equal "abb", "abbcccddddeeeee"[/abb?/]
    assert_equal "abbc", "abbcccddddeeeee"[/abbc?/]
    assert_equal "", "abbcccddddeeeee"[/b?c?/] # UGL occhio, non "bc", che strano
    assert_equal "ab", "abbcccddddeeeee"[/ab?c?/]
  end
  ...
  def test_plus_means_one_or_more
    ...
    assert_equal "bccc", "abbcccddddeeeee"[/b?c+/]
  ...
  def test_asterisk_means_zero_or_more
    ...
    # UGL BOHO... aggiunte io per provare, appunto
    assert_equal "", ""[/z*/]   # UGL occhio, non nil
    assert_equal "abbcccddddeeeee", "abbcccddddeeeee"[/.*/]
  end
  ...
  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/] # UGL, occhio non "az" perchè matcha prima la "a" iniziale
  end
  ...
  def test_caret_anchors_to_the_start_of_lines
    ...
    # UGL aggiunte io
    assert_equal "42", "42 in 1st line\n2 lines"[/^\d+/]
    assert_equal "42", "num 42 in 1st line\n2 lines"[/\d+/]
  end
  ...
  def test_sub_is_like_find_and_replace
    ...
    # UGL aggiunte io 
    assert_equal "one any-three", "one two-three".sub(/(t\w*)/) { "any" }
  end
  ...
  def test_gsub_is_like_find_and_replace_all
    ...
    # UGL aggiunte io 
    assert_equal "one any-any", "one two-three".gsub(/(t\w*)/) { "any" }
    assert_equal "one w-h", "one two-three".gsub(/(t\w*)/) { $1[1, 1] }
  end
end
