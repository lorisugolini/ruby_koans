...
class AboutBlocks < Neo::Koan
  ...
  # UGL per i blocchi molto più chiaro questo: http://labs.codecademy.com/BJrB#:workspace
  ...
  def test_block_can_affect_variables_in_the_code_where_they_are_created
    value = :initial_value
    ugl = method_with_block { value = :modified_in_a_block }
    assert_equal :modified_in_a_block, value

    # UGL aggiunto io
    assert_equal value, ugl
  end
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    # UGL aggiunto io per provare cosa succende senza l'&
    begin
      result = method_with_block_arguments(make_upper)      
    rescue Exception => ex
