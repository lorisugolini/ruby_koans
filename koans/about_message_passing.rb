...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # UGL la rispsta qui: http://stackoverflow.com/questions/4658269/ruby-send-vs-send
  end
  ...
  def test_foo_method_are_caught
    ...
    # UGL aggiunto io, ma dá errore perché sotto viene
    # riaperta la classe aggiungendo un'implementazione
    # di respond_to che viene vista anche in questo punto
    # assert_equal false, catcher.respond_to?(:foo_bar)
  end
