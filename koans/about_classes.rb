...
class AboutClasses < Neo::Koan
  ...
  class Dog2
    # UGL aggiunto io, e stranamente il primo test sotto non si rompe
    @name = "any initial/default value"
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # UGL giustamente, non gli passiamo l'argomento dichiarato
    # nell'initialize, che è un (anzi "il") costruttore
  end
